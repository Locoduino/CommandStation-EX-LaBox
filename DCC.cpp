...
void DCC::forgetLoco(int cab)
{                       // removes any speed reminders for this loco
...
void DCC::forgetAllLocos()
{                     // removes all speed reminders
...
void DCC::issueReminders()
{
  ...
  if (DCCWaveform::mainTrack.getPacketPending())
    return;
